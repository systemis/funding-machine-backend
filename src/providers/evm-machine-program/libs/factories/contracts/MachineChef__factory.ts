...
export class MachineChef__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<MachineChef>;
  }
  ...
  override attach(address: string): MachineChef {
    return super.attach(address) as MachineChef;
  }
  override connect(signer: Signer): MachineChef__factory {
    return super.connect(signer) as MachineChef__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): MachineChefInterface {
    return new utils.Interface(_abi) as MachineChefInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MachineChef {
    return new Contract(address, _abi, signerOrProvider) as MachineChef;
  }
}
